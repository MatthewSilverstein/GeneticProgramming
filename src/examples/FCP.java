/*
 * This class uses the Genetic Programming library to factor complex polynomials
 * into linear roots.
 */
...
public class FCP {
	...
	public static void factorPolynomial(){
		 ...
		 * the algorithm tries to factor the polynomial into its linear roots.
		 */
		System.out.println("Enter a polynomial to be factored, for more information on syntax see helpCPolynomialInput()");
		...
		DoubleObj[] outputVector=new DoubleObj[f.getDegree()*2 + 2];
		GTree best=null;
